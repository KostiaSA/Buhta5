...
namespace Buhta
{
    ...
    public class SchemaFormPage : SchemaFormControl
    {
        ...
        ////                {
        ////                    throw new Exception("ОШИБКА: PageMiddlePanel содержит более одного элемента.");
        ////                }
        ...
        ////                }
        ////                else
        ////                    throw new Exception("ОШИБКА: Недопустимый элемент '" + schemaControl.GetType().Name + "' в SchemaFormPage.");
