...
namespace Buhta
{
    public class bsGridDataSourceToSqlDataViewBinder : OneWayBinder<object>
    {
        ...
        public bsGridDataSourceToSqlDataViewBinder()
        {
        ...
        public override string GetJsForSettingProperty()
        {
            ...
            if (!(_view is DataView))
                throw new Exception(nameof(bsGridDataSourceToSqlDataViewBinder) + ": свойство '" + DatasourceModelPropertyName + "' должно быть типа '" + nameof(DataView) + "'");
            ...
            if (SelectedRowsModelPropertyName != null)
            {
                ...
                if (!(_selectedRows is ObservableCollection<string>))
                    throw new Exception(nameof(bsGridDataSourceToSqlDataViewBinder) + ": свойство '" + SelectedRowsModelPropertyName + "' должно быть типа '" + nameof(ObservableCollection<string>) + "'");
